...
(()=>{
    const e = new Error("Cannot find module '@/component/query-provider'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '../component/smooth-scroll'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__03ce5753._.js.map